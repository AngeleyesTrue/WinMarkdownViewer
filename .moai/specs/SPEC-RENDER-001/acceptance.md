...
- [x] KaTeX 인라인 수식 ($...$) 렌더링 동작 확인
- [x] KaTeX 블록 수식 ($$...$$) 렌더링 동작 확인
- [x] Mermaid flowchart 다이어그램 렌더링 동작 확인
- [x] Mermaid sequence 다이어그램 렌더링 동작 확인
- [x] Mermaid class/state/gantt/pie 다이어그램 렌더링 동작 확인
- [x] 코드 블록 내 달러 기호가 수식으로 처리되지 않음 확인
- [x] 수식 구문 오류 시 오류 메시지 표시 및 문서 렌더링 유지 확인
- [x] 다이어그램 구문 오류 시 오류 메시지 표시 및 문서 렌더링 유지 확인
- [x] 오프라인 환경에서 정상 동작 확인
- [x] 테스트 커버리지 85% 이상
- [x] 바이너리 크기 증가 2MB 이내
